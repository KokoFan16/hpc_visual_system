...
int main(int argc, char **argv)
{
    ...
    ctx.set_timestep(t, 1);
    ctx.set_rank(rank, nprocs);
    ctx.set_namespath("");

	Events e(ctx, "main"); //"size:100"
    ...
    
    {
		...
		for (int k = 0; k <= maxGeneration; k++)
		{
			...
			{
				Events e(ctx, "exchange", "COMM", 2, k);
			...
			{
				Events e(ctx, "BoardChange", "COMP", 2, k);
			...
			{
				Events e(ctx, "statusCheck", "COMP", 2, k);
